...
### P2-13. Recalibrer le rythme du moteur de match (rucks/plaquages/coups de pied trop nombreux, pénalités trop rares) — NOUVEAU (découvert par P2-11)
- Statut : À FAIRE
- Priorité : P2 (crédibilité de la simulation)
- Fichiers concernés : `engine/rugby-engine.js`, `server/simulate-batch.js` (fourchettes à remettre à jour une fois le moteur recalibré), `server/test-stats-matchs.js` (repères à resserrer une fois atteints)

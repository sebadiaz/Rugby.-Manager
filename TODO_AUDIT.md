...
- Statut : EN COURS (incrément 1 : offloads — voir journal ci-dessous)
...
- Reste à faire (voir plan complet dans la section P2-13 ci-dessus) : T2 (temps mort/ballon en jeu, le plus gros levier), T4 (turnovers), T5 (pénalités), T6 (entrées dans les 22m), T7 (mètres gagnés).
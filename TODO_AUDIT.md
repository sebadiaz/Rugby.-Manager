...
**Domaines restants (tranches suivantes possibles, non commencées).** Sauvegarde/migration — dépendances croisées à vérifier avant de couper, comme pour les tranches précédentes. `clubUI.js` (rendu) n'a pas encore été commencé.
